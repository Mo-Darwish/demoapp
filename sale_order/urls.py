...
from .views import OrderViewSet, SaleOrderView, OrdersViewV2 , sale_order_ui , ItemSaleOrderViewSet , StockExchangeViewSet
app_name = 'sale_order'
...
v1_router.register("sale-order-items", ItemSaleOrderViewSet, basename='sale-order-items')
v1_router.register("sale-order-items", StockExchangeViewSet, basename='sale-order-stockexchange')
